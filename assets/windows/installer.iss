...
Source: "../../target/package/popcorn-time.jar"; DestDir: "{app}\main\0.9.6"; Flags: ignoreversion
Source: "../../target/package/libfx.exe"; DestDir: "{app}\main\0.9.6"; Flags: ignoreversion
Source: "../../target/package/libfx.pdb"; DestDir: "{app}\main\0.9.6"; Flags: ignoreversion skipifsourcedoesntexist
