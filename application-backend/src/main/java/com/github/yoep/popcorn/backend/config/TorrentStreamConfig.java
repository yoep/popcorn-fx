...
public class TorrentStreamConfig {
    ...
    public TorrentStreamService streamService(FxLib fxLib, PopcornFx instance, TorrentService torrentService) {
        return new TorrentStreamServiceImpl(fxLib, instance, torrentService);
    }
}
