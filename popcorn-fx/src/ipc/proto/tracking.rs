...
pub mod tracking_provider {
    ...
    pub struct AuthorizationError {
        ...
        // @@protoc_insertion_point(field:fx.ipc.proto.TrackingProvider.AuthorizationError.client_error)
        pub client_error: ::protobuf::MessageField<authorization_error::ClientError>,
        // special fields
    ...
    impl ::protobuf::Message for AuthorizationError {
        ...
        fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    18 => {
                        ::protobuf::rt::read_singular_message_into_field(is, &mut self.client_error)?;
                    },
                    tag => {
                        ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let Some(v) = self.client_error.as_ref() {
        ...
        fn default_instance() -> &'static AuthorizationError {
            static instance: AuthorizationError = AuthorizationError {
                ...
                client_error: ::protobuf::MessageField::none(),
                special_fields: ::protobuf::SpecialFields::new(),
            };
            &instance
        }
    ...
    pub mod authorization_error {
        // @@protoc_insertion_point(message:fx.ipc.proto.TrackingProvider.AuthorizationError.ClientError)
        #[derive(PartialEq,Clone,Default,Debug)]
        pub struct ClientError {
            // message fields
            // @@protoc_insertion_point(field:fx.ipc.proto.TrackingProvider.AuthorizationError.ClientError.error)
            pub error: ::std::string::String,
            // special fields
            // @@protoc_insertion_point(special_field:fx.ipc.proto.TrackingProvider.AuthorizationError.ClientError.special_fields)
            pub special_fields: ::protobuf::SpecialFields,
        }
        ...
        pub enum Type {
            ...
            // @@protoc_insertion_point(enum_value:fx.ipc.proto.TrackingProvider.AuthorizationError.Type.CLIENT)
            CLIENT = 4,
        }
        ...
        impl ::protobuf::Enum for Type {
            ...
            fn from_i32(value: i32) -> ::std::option::Option<Type> {
                match value {
                    ...
                    4 => ::std::option::Option::Some(Type::CLIENT),
            ...
            fn from_str(str: &str) -> ::std::option::Option<Type> {
                match str {
                    ...
                    "CLIENT" => ::std::option::Option::Some(Type::CLIENT),
                    _ => ::std::option::Option::None
                }
            }
