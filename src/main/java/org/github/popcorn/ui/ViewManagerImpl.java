...
import org.github.popcorn.PopcornTimeApplication;
import org.github.popcorn.ui.exceptions.PrimaryWindowAlreadyPresentException;
import org.github.popcorn.ui.exceptions.PrimaryWindowNotAvailableException;
import org.github.popcorn.ui.exceptions.WindowNotFoundException;
...
public class ViewManagerImpl implements ViewManager {
    ...
    private void exitApplication() {
        Platform.exit();
        ((ConfigurableApplicationContext) PopcornTimeApplication.APPLICATION_CONTEXT).close();
        System.exit(0);
    }
