...
/**
 * Create an empty Media VideoPlayer object
 *
 * \param p_libvlc_instance the libvlc instance in which the Media VideoPlayer
 *        should be created.
...
/**
 * Create a Media VideoPlayer object from a Media
 *
 ...
 *
 * \param p_mi the Media VideoPlayer to free
 */
 ...
 *
 * \param mp the Media VideoPlayer
