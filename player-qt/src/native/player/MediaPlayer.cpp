...
{
#if defined(Q_OS_WIN)
    _log->trace("Adding Windows window to the VLC media player");
    void *drawable = (void *)wid;
    libvlc_media_player_set_hwnd(_vlcMediaPlayer, drawable);
#elif defined(Q_OS_MAC)
    _log->trace("Adding Mac window to the VLC media player");
    void *drawable = (void *)wid;
    libvlc_media_player_set_nsobject(_vlcMediaPlayer, drawable);
#else
