...
mod tests {
    ...
    fn test_process_url() {
        ...
        let callback = MultiThreadedCallback::new(Arc::new(Runtime::new().unwrap()));
        ...
        let result_handle = rx_handle.recv_timeout(Duration::from_millis(200)).unwrap();
        assert_eq!(expected_handle, result_handle);
    }
